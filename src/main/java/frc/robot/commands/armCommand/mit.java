...
public class mit extends Command{
  ...
  private double delta_ender ;
    ...
    public mit(ArmSubsystem subsystem) {
...
delta_encoder = subsystem.getEncoder1() - subsystem.getEncoder2();
  ...
  public void execute() {
    ...
    current_time =stopWatch.getDuration(); 
    ...
    delta_ender= (delta_encoder-middle_delta_encoder)/((stopWatch.getDuration()-current_time));
    System.out.println(delta_encoder-middle_delta_encoder);
    System.out.println(stopWatch.getDuration()-current_time);
